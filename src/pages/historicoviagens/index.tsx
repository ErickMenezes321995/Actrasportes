            ...
            <CardHeader bg="white" py={4} borderBottom="1px solid #d0d0d0">
              <Flex justify="space-between" align="center" flexWrap="wrap">
                ...
                <Flex gap={3} align="center">
                 <Button
                 onClick={()=>{
                  navigate(`/rota/${viagem.id}`)
                 }}
                    bg="linear-gradient(135deg, #e6f0ff 0%, #d1e1ff 100%)"
                    color="#15457b"
                    border="1px solid"
                    ...
                    overflow="hidden"
                    _hover={{
                      bg: "linear-gradient(135deg, #d1e1ff 0%, #b5d0ff 100%)",
                      transform: "translateY(-1px)",
                      boxShadow: "0 4px 12px rgba(21, 69, 123, 0.15)",
                      borderColor: "blue.300",
                    }}
                    _active={{
                      transform: "translateY(0)",
                      boxShadow: "0 2px 6px rgba(21, 69, 123, 0.1)",
                    }}
                    _focus={{
